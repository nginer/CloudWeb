...
<html>
 <head>
  ...
  <body>
    ...
    <div class="container" >
      <div class="login col-md-offset-1">
        <div class="login-screen" style="width:89.2%;color:black;">
          ...
          <form action="">
          	用户名<input type="text" class="form-control" id="inputSuccess" name="serviceName" />
          	  密码<input type="text" class="form-control" id="inputSuccess" name="serviceName" />
            <a class="btn btn-primary btn-large btn-block" href="http://www.bootcss.com/p/flat-ui/#">Login</a>
